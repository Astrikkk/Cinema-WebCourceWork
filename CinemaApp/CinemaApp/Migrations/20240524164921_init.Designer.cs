...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaApp.Data.Entities.Film", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaApp.Data.Entities.Seans", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            FilmId = 1,
                            ShowTime = new DateTime(2024, 5, 22, 18, 30, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            FilmId = 2,
                            ShowTime = new DateTime(2024, 5, 22, 20, 30, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 3,
                            FilmId = 3,
                            ShowTime = new DateTime(2024, 5, 23, 17, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });

            modelBuilder.Entity("CinemaApp.Data.Entities.Seat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaApp.Data.Entities.Seans", b =>
                {
                    b.HasOne("CinemaApp.Data.Entities.Film", "Film")
                        .WithMany()
            ...
            modelBuilder.Entity("CinemaApp.Data.Entities.Seat", b =>
                {
                    b.HasOne("CinemaApp.Data.Entities.Seans", "Seans")
                        .WithMany("Seats")
